...
export class L6FirstFloorDestroyedGenerator implements Generator {
  ...
  levelStartMessage(): string {
    return 'As you can now see, the first floor of Corvus Lab is pretty well demolished. Just need to find a way out and back to your ship in the hangar now.'
  }
